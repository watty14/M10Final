...
public class ReportsUtility {
	...
	public String generateTransactionHistory(BankAccount account, Calendar from, 
			Calendar to) {
	...
	private ArrayList<Transactions> filterByDate(ArrayList<Transactions> list, Calendar from,
			Calendar to) {
